/**
 * Backfill US Summer 2027 internships from Fantastic.jobs (7-day window).
 * Usage: npm run sync:fantastic-2027
 */
import fs from "fs";
...
async function main() {
  ...
  console.log("Fetching US 2027 internships from Fantastic.jobs (7d window)...");
